...
module.exports = {
  ...
  networks: {
    ...
    proteus: {
      ...
      network_id: 88002, // Sepolia's network ID
      // gasPrice: 1000, // Set the gas price to an appropriate value
    ...
    bitgert: {
      provider: () =>
        new HDWalletProvider(privateKey, `https://testnet-rpc.brisescan.com`),
      network_id: 64668,
    },
    scroll_alpha: {
      provider: () =>
        new HDWalletProvider(privateKey, `https://alpha-rpc.scroll.io/l2`),
      network_id: 534353,
      gasPrice: 100000,
      gas: 21000,
    },
